...
public class StateCodec_Fence implements BlockStateCodec, Serializable {
    ...
    public Material[] getApplicableMaterials() {
        return new Material[] { 
            ...
            Material.OAK_FENCE, Material.SPRUCE_FENCE, Material.ANDESITE_WALL, Material.BRICK_WALL, Material.COBBLESTONE_WALL, 
            Material.DIORITE_WALL, Material.END_STONE_BRICK_WALL, Material.GRANITE_WALL, Material.IRON_BARS, Material.MOSSY_COBBLESTONE_WALL,
            Material.MOSSY_STONE_BRICK_WALL, Material.NETHER_BRICK_WALL, Material.OAK_FENCE_GATE, Material.PRISMARINE_WALL, 
            Material.RED_NETHER_BRICK_WALL, Material.RED_SANDSTONE_WALL, Material.SANDSTONE_WALL, Material.STONE_BRICK_WALL
        };
    }
